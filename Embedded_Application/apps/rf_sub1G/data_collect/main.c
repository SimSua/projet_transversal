...
#define DEVICE_ADDRESS  0xB5 /* Addresses 0x00 and 0xFF are broadcast */
#define NEIGHBOR_ADDRESS 0xB6 /* Address of the associated device */
/***************************************************************************** */
/* Pins configuration */
...
int main(void)
{
	...
	uprintf(UART0, "Data Collect started : Receive data from Sensors\n\r");
